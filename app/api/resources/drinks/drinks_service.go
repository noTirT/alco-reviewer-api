...
type DrinksService interface{
    ...
    GetDrinksByLocationId(request *DrinksByLocationRequest) ([]Drink, error)
}
...
func (service *drinksService) GetDrinksByLocationId(request *DrinksByLocationRequest) ([]Drink, error) {
    return service.repo.GetDrinksByLocationId(request.LocationId)
}
